...
class UI {
  static const double minimalWidthForWindows = 540.0;
  ...
  static Widget getTaskifyLogo({
    double size = 64.0,
    bool rounded = true,
    double radius = 10.0,
    bool lowQuality = false,
  }) {
    String logoFileString = lowQuality ? 'icon.ico' : 'logo.png';
    logoFileString = 'assets/images/app_$logoFileString';
